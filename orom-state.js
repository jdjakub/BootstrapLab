...
state('vtable', dom('INPUT', '3'));
state('name', dom('INPUT', 'entity.dom-node'));
state('code', dom('TEXTAREA', atob('')));
object(12);
state('id', dom('INPUT', '12'));
state('vtable', dom('INPUT', '3'));
state('name', dom('INPUT', 'new-vtable.allocate'));
state('code', dom('TEXTAREA', atob('ZnVuY3Rpb24ocmN2KSB7CiAgbGV0IG8gPSBuZXdfb2JqZWN0KCk7CiAgc3RhdGUobywgJ3Z0YWJsZScsIHJjdik7CiAgcmV0dXJuIG87Cn0=')));
object(13);
...
state('-dom-node', dom('INPUT', '11'));
state('-clicked', dom('INPUT', '18'));
object(15);
...
object(16);
state('id', dom('INPUT', '16'));
state('vtable', dom('INPUT', '3'));
state('name', dom('INPUT', 'view.attach'));
state('code', dom('TEXTAREA', atob('ZnVuY3Rpb24odmlldywgb2JqKSB7CiAgbGV0IGRvbSA9IHNlbmQob2JqLCAnZG9tLW5vZGUnLCB2aWV3KTsKICB2aWV3LmRpdi5hcHBlbmRDaGlsZChkb20pOwp9')));
object(17);
state('id', dom('INPUT', '17'));
state('vtable', dom('INPUT', '13'));
state('name', dom('INPUT', 'view vtable'));
state('-attach', dom('INPUT', '16'));
object(18);
state('id', dom('INPUT', '18'));
state('vtable', dom('INPUT', '3'));
state('name', dom('INPUT', 'entity.clicked'));
state('code', dom('TEXTAREA', atob('ZnVuY3Rpb24ocmN2LCBlKSB7CiAgbGV0IFt4LHldID0gW2Uub2Zmc2V0WCwgZS5vZmZzZXRZXTsKICBhbGVydChgSSB3YXMgY2xpY2tlZCBhdCAoJHt4fSwke3l9KSFgKTsKfQ==')));
